...
export const MorningStar = createPattern({
  name: 'Morning Star', shortName: 'MS', label: 'MS', signal: 'bullish', startIndex: 2,
...
export const { calculate, metadata, defaultInputs, inputConfig, plotConfig } = MorningStar;
