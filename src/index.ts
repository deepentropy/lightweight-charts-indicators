...
// Medium Wave 3 Community Indicators
import * as autoFiboIndicatorsIndicator from './community/auto-fibo-indicators';
import * as heatmapVolumeIndicator from './community/heatmap-volume';
import * as betterVolumeIndicator from './community/better-volume';
import * as volumeDivergenceIndicator from './community/volume-divergence';
import * as predictiveChannelsIndicator from './community/predictive-channels';
import * as volumeBarBreakoutIndicator from './community/volume-bar-breakout';
import * as redkMomentumBarsIndicator from './community/redk-momentum-bars';
import * as vumanChuSwingIndicator from './community/vumanchu-swing';
import * as tweezersKangarooTailIndicator from './community/tweezers-kangaroo-tail';
import * as bitcoinLogCurvesIndicator from './community/bitcoin-log-curves';
import * as hemaTrendLevelsIndicator from './community/hema-trend-levels';
import * as rsiMomentumDivergenceIndicator from './community/rsi-momentum-divergence';
import * as fvgPositioningAverageIndicator from './community/fvg-positioning-average';
import * as momentumZigZagIndicator from './community/momentum-zigzag';
import * as rangeDetectorIndicator from './community/range-detector';
import * as swingHighsLowsPatternsIndicator from './community/swing-highs-lows-patterns';
import * as trendLineAutoIndicator from './community/trend-line-auto';
import * as intradayVolumeSwingsIndicator from './community/intraday-volume-swings';
import * as realtimeVolumeBarsIndicator from './community/realtime-volume-bars';
import * as volumaticSRLevelsIndicator from './community/volumatic-sr-levels';
import * as vwapMvwapEmaCrossoverIndicator from './community/vwap-mvwap-ema-crossover';
import * as volumeFootprintIndicator from './community/volume-footprint';
import * as hyperTrendIndicator from './community/hyper-trend';
import * as trendlinesWithBreaksIndicator from './community/trendlines-with-breaks';
import * as trendImpulseChannelsIndicator from './community/trend-impulse-channels';
import * as liquidityGrabsIndicator from './community/liquidity-grabs';
import * as rsiTopsBottomsIndicator from './community/rsi-tops-bottoms';
import * as hullButterflyOscillatorIndicator from './community/hull-butterfly-oscillator';
import * as gmmaOscillatorIndicator from './community/gmma-oscillator';
import * as bjorgumTsiIndicator from './community/bjorgum-tsi';
import * as adxDiGu5Indicator from './community/adx-di-gu5';
import * as marketStructureTrailingStopIndicator from './community/market-structure-trailing-stop';
import * as dynamicStructureIndicatorIndicator from './community/dynamic-structure-indicator';
import * as standardizedMacdHaIndicator from './community/standardized-macd-ha';
import * as hottLottIndicator from './community/hott-lott';
import * as stochasticHeatMapIndicator from './community/stochastic-heat-map';
import * as tdiRsiIndicator from './community/tdi-rsi';
import * as heikinAshiRsiOscillatorIndicator from './community/heikin-ashi-rsi-oscillator';
import * as maStrategyEmperorIndicator from './community/ma-strategy-emperor';
import * as multipleDivergencesIndicator from './community/multiple-divergences';
import * as priceDivergenceDetectorIndicator from './community/price-divergence-detector';
import * as qqeCrossIndicator from './community/qqe-cross';
import * as wavetrendOscillatorIndicator from './community/wavetrend-oscillator';
import * as openCloseCrossIndicator from './community/open-close-cross';
import * as superGuppyIndicator from './community/super-guppy';
import * as bjorgumAutotrailIndicator from './community/bjorgum-autotrail';
import * as deltaRsiOscillatorIndicator from './community/delta-rsi-oscillator';
import * as macdReloadedIndicator from './community/macd-reloaded';
import * as renkoChartIndicator from './community/renko-chart';
import * as redkEverexIndicator from './community/redk-everex';
import * as boomHunterProIndicator from './community/boom-hunter-pro';
import * as bigSnapperAlertsIndicator from './community/big-snapper-alerts';
import * as rsiSupplyDemandIndicator from './community/rsi-supply-demand';
import * as ultimateBuySellIndicator from './community/ultimate-buy-sell';
import * as macdSupportResistanceIndicator from './community/macd-support-resistance';
import * as liquidityLevelsIndicator from './community/liquidity-levels';
import * as zigzagFibonacciIndicator from './community/zigzag-fibonacci';
import * as trendLinesV2Indicator from './community/trend-lines-v2';
import * as orderBlocksSignalsIndicator from './community/order-blocks-signals';
import * as supportResistanceChannelsIndicator from './community/support-resistance-channels';
...
export { BetterVolume } from './community/better-volume';
export { VolumeDivergence } from './community/volume-divergence';
export { PredictiveChannels } from './community/predictive-channels';
export { VolumeBarBreakout } from './community/volume-bar-breakout';
export { RedKMomentumBars } from './community/redk-momentum-bars';
export { VuManChuSwing } from './community/vumanchu-swing';
export { TweezersKangarooTail } from './community/tweezers-kangaroo-tail';
export { BitcoinLogCurves } from './community/bitcoin-log-curves';
export { HemaTrendLevels } from './community/hema-trend-levels';
export { RsiMomentumDivergence } from './community/rsi-momentum-divergence';
export { FvgPositioningAverage } from './community/fvg-positioning-average';
export { MomentumZigZag } from './community/momentum-zigzag';
export { RangeDetector } from './community/range-detector';
export { SwingHighsLowsPatterns } from './community/swing-highs-lows-patterns';
export { TrendLineAuto } from './community/trend-line-auto';
export { IntradayVolumeSwings } from './community/intraday-volume-swings';
export { RealtimeVolumeBars } from './community/realtime-volume-bars';
export { VolumaticSRLevels } from './community/volumatic-sr-levels';
export { VwapMvwapEmaCrossover } from './community/vwap-mvwap-ema-crossover';
export { VolumeFootprint } from './community/volume-footprint';

export type { AutoFiboIndicatorsInputs } from './community/auto-fibo-indicators';
export type { HeatmapVolumeInputs } from './community/heatmap-volume';
export type { BetterVolumeInputs } from './community/better-volume';
export type { VolumeDivergenceInputs } from './community/volume-divergence';
export type { PredictiveChannelsInputs } from './community/predictive-channels';
export type { VolumeBarBreakoutInputs } from './community/volume-bar-breakout';
export type { RedKMomentumBarsInputs } from './community/redk-momentum-bars';
export type { VuManChuSwingInputs } from './community/vumanchu-swing';
export type { TweezersKangarooTailInputs } from './community/tweezers-kangaroo-tail';
export type { BitcoinLogCurvesInputs } from './community/bitcoin-log-curves';
export type { HemaTrendLevelsInputs } from './community/hema-trend-levels';
export type { RsiMomentumDivergenceInputs } from './community/rsi-momentum-divergence';
export type { FvgPositioningAverageInputs } from './community/fvg-positioning-average';
export type { MomentumZigZagInputs } from './community/momentum-zigzag';
export type { RangeDetectorInputs } from './community/range-detector';
export type { SwingHighsLowsPatternsInputs } from './community/swing-highs-lows-patterns';
export type { TrendLineAutoInputs } from './community/trend-line-auto';
export type { IntradayVolumeSwingsInputs } from './community/intraday-volume-swings';
export type { RealtimeVolumeBarsInputs } from './community/realtime-volume-bars';
export type { VolumaticSRLevelsInputs } from './community/volumatic-sr-levels';
export type { VwapMvwapEmaCrossoverInputs } from './community/vwap-mvwap-ema-crossover';
export type { VolumeFootprintInputs } from './community/volume-footprint';
...
export const indicatorRegistry: IndicatorRegistryEntry[] = [
  ...
  {
    id: 'auto-fibo-indicators',
    group: 'community',
    name: 'Auto Fibo on Indicators',
    shortName: 'AutoFibo',
    category: 'Oscillators',
    overlay: false,
    metadata: autoFiboIndicatorsIndicator.metadata,
    inputConfig: autoFiboIndicatorsIndicator.inputConfig as InputConfig[],
    plotConfig: autoFiboIndicatorsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...autoFiboIndicatorsIndicator.defaultInputs },
    calculate: autoFiboIndicatorsIndicator.calculate,
  },
  {
    id: 'heatmap-volume',
    group: 'community',
    ...
    category: 'Volume',
    overlay: false,
    metadata: heatmapVolumeIndicator.metadata,
    inputConfig: heatmapVolumeIndicator.inputConfig as InputConfig[],
    plotConfig: heatmapVolumeIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...heatmapVolumeIndicator.defaultInputs },
    calculate: heatmapVolumeIndicator.calculate,
  },
  {
    id: 'better-volume',
    group: 'community',
    ...
    category: 'Volume',
    overlay: false,
    metadata: betterVolumeIndicator.metadata,
    inputConfig: betterVolumeIndicator.inputConfig as InputConfig[],
    plotConfig: betterVolumeIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...betterVolumeIndicator.defaultInputs },
    calculate: betterVolumeIndicator.calculate,
  },
  {
    ...
    category: 'Volume',
    overlay: false,
    metadata: volumeDivergenceIndicator.metadata,
    inputConfig: volumeDivergenceIndicator.inputConfig as InputConfig[],
    plotConfig: volumeDivergenceIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...volumeDivergenceIndicator.defaultInputs },
    calculate: volumeDivergenceIndicator.calculate,
  },
  {
    id: 'predictive-channels',
    group: 'community',
    name: 'Predictive Channels',
    shortName: 'PC',
    category: 'Channels & Bands',
    overlay: true,
    metadata: predictiveChannelsIndicator.metadata,
    inputConfig: predictiveChannelsIndicator.inputConfig as InputConfig[],
    plotConfig: predictiveChannelsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...predictiveChannelsIndicator.defaultInputs },
    calculate: predictiveChannelsIndicator.calculate,
  },
  {
    id: 'volume-bar-breakout',
    group: 'community',
    name: 'Volume Bar Breakout',
    shortName: 'VolBreak',
    category: 'Volume',
    overlay: true,
    metadata: volumeBarBreakoutIndicator.metadata,
    inputConfig: volumeBarBreakoutIndicator.inputConfig as InputConfig[],
    plotConfig: volumeBarBreakoutIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...volumeBarBreakoutIndicator.defaultInputs },
    calculate: volumeBarBreakoutIndicator.calculate,
  },
  {
    id: 'redk-momentum-bars',
    group: 'community',
    name: 'RedK Momentum Bars',
    shortName: 'MoBars',
    category: 'Momentum',
    overlay: false,
    metadata: redkMomentumBarsIndicator.metadata,
    inputConfig: redkMomentumBarsIndicator.inputConfig as InputConfig[],
    plotConfig: redkMomentumBarsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...redkMomentumBarsIndicator.defaultInputs },
    calculate: redkMomentumBarsIndicator.calculate,
  },
  {
    id: 'vumanchu-swing',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: vumanChuSwingIndicator.metadata,
    inputConfig: vumanChuSwingIndicator.inputConfig as InputConfig[],
    plotConfig: vumanChuSwingIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...vumanChuSwingIndicator.defaultInputs },
    calculate: vumanChuSwingIndicator.calculate,
  },
  {
    id: 'tweezers-kangaroo-tail',
    group: 'community',
    name: 'Tweezers & Kangaroo Tail',
    shortName: 'Tweez/Kang',
    category: 'Candlestick Patterns',
    overlay: true,
    metadata: tweezersKangarooTailIndicator.metadata,
    inputConfig: tweezersKangarooTailIndicator.inputConfig as InputConfig[],
    plotConfig: tweezersKangarooTailIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...tweezersKangarooTailIndicator.defaultInputs },
    calculate: tweezersKangarooTailIndicator.calculate,
  },
  {
    id: 'bitcoin-log-curves',
    group: 'community',
    name: 'Bitcoin Log Growth Curves',
    shortName: 'BTC Log',
    category: 'Trend',
    overlay: true,
    metadata: bitcoinLogCurvesIndicator.metadata,
    inputConfig: bitcoinLogCurvesIndicator.inputConfig as InputConfig[],
    plotConfig: bitcoinLogCurvesIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...bitcoinLogCurvesIndicator.defaultInputs },
    calculate: bitcoinLogCurvesIndicator.calculate,
  },
  {
    id: 'hema-trend-levels',
    group: 'community',
    name: 'HEMA Trend Levels',
    shortName: 'HEMA',
    category: 'Trend',
    overlay: true,
    metadata: hemaTrendLevelsIndicator.metadata,
    inputConfig: hemaTrendLevelsIndicator.inputConfig as InputConfig[],
    plotConfig: hemaTrendLevelsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...hemaTrendLevelsIndicator.defaultInputs },
    calculate: hemaTrendLevelsIndicator.calculate,
  },
  {
    id: 'rsi-momentum-divergence',
    group: 'community',
    name: 'RSI Momentum Divergence',
    shortName: 'RSIM Div',
    category: 'Oscillators',
    overlay: false,
    metadata: rsiMomentumDivergenceIndicator.metadata,
    inputConfig: rsiMomentumDivergenceIndicator.inputConfig as InputConfig[],
    plotConfig: rsiMomentumDivergenceIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...rsiMomentumDivergenceIndicator.defaultInputs },
    calculate: rsiMomentumDivergenceIndicator.calculate,
  },
  {
    id: 'fvg-positioning-average',
    group: 'community',
    name: 'FVG Positioning Average',
    shortName: 'FVG Pos Avg',
    category: 'Trend',
    overlay: true,
    metadata: fvgPositioningAverageIndicator.metadata,
    inputConfig: fvgPositioningAverageIndicator.inputConfig as InputConfig[],
    plotConfig: fvgPositioningAverageIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...fvgPositioningAverageIndicator.defaultInputs },
    calculate: fvgPositioningAverageIndicator.calculate,
  },
  {
    id: 'momentum-zigzag',
    group: 'community',
    name: 'Momentum-based ZigZag',
    shortName: 'MomZZ',
    category: 'Trend',
    overlay: true,
    metadata: momentumZigZagIndicator.metadata,
    inputConfig: momentumZigZagIndicator.inputConfig as InputConfig[],
    plotConfig: momentumZigZagIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...momentumZigZagIndicator.defaultInputs },
    calculate: momentumZigZagIndicator.calculate,
  },
  {
    id: 'range-detector',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: rangeDetectorIndicator.metadata,
    inputConfig: rangeDetectorIndicator.inputConfig as InputConfig[],
    plotConfig: rangeDetectorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...rangeDetectorIndicator.defaultInputs },
    calculate: rangeDetectorIndicator.calculate,
  },
  {
    id: 'swing-highs-lows-patterns',
    group: 'community',
    name: 'Swing Highs/Lows & Candle Patterns',
    shortName: 'SwingPat',
    category: 'Candlestick Patterns',
    overlay: true,
    metadata: swingHighsLowsPatternsIndicator.metadata,
    inputConfig: swingHighsLowsPatternsIndicator.inputConfig as InputConfig[],
    plotConfig: swingHighsLowsPatternsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...swingHighsLowsPatternsIndicator.defaultInputs },
    calculate: swingHighsLowsPatternsIndicator.calculate,
  },
  {
    id: 'trend-line-auto',
    group: 'community',
    name: 'Trend Line Auto',
    shortName: 'TrendLine',
    category: 'Trend',
    overlay: true,
    metadata: trendLineAutoIndicator.metadata,
    inputConfig: trendLineAutoIndicator.inputConfig as InputConfig[],
    plotConfig: trendLineAutoIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...trendLineAutoIndicator.defaultInputs },
    calculate: trendLineAutoIndicator.calculate,
  },
  {
    id: 'intraday-volume-swings',
    group: 'community',
    name: 'Intraday Volume Swings',
    shortName: 'IVS',
    category: 'Volume',
    overlay: true,
    metadata: intradayVolumeSwingsIndicator.metadata,
    inputConfig: intradayVolumeSwingsIndicator.inputConfig as InputConfig[],
    plotConfig: intradayVolumeSwingsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...intradayVolumeSwingsIndicator.defaultInputs },
    calculate: intradayVolumeSwingsIndicator.calculate,
  },
  {
    id: 'realtime-volume-bars',
    group: 'community',
    name: 'Realtime Volume Bars',
    shortName: 'VolBuySell',
    category: 'Volume',
    overlay: false,
    metadata: realtimeVolumeBarsIndicator.metadata,
    inputConfig: realtimeVolumeBarsIndicator.inputConfig as InputConfig[],
    plotConfig: realtimeVolumeBarsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...realtimeVolumeBarsIndicator.defaultInputs },
    calculate: realtimeVolumeBarsIndicator.calculate,
  },
  {
    id: 'volumatic-sr-levels',
    group: 'community',
    name: 'Volumatic S/R Levels',
    shortName: 'VolSR',
    category: 'Trend',
    overlay: true,
    metadata: volumaticSRLevelsIndicator.metadata,
    inputConfig: volumaticSRLevelsIndicator.inputConfig as InputConfig[],
    plotConfig: volumaticSRLevelsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...volumaticSRLevelsIndicator.defaultInputs },
    calculate: volumaticSRLevelsIndicator.calculate,
  },
  {
    id: 'vwap-mvwap-ema-crossover',
    group: 'community',
    name: 'VWAP/MVWAP/EMA Crossover',
    shortName: 'VWAP-X',
    category: 'Trend',
    overlay: true,
    metadata: vwapMvwapEmaCrossoverIndicator.metadata,
    inputConfig: vwapMvwapEmaCrossoverIndicator.inputConfig as InputConfig[],
    plotConfig: vwapMvwapEmaCrossoverIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...vwapMvwapEmaCrossoverIndicator.defaultInputs },
    calculate: vwapMvwapEmaCrossoverIndicator.calculate,
  },
  {
    id: 'volume-footprint',
    group: 'community',
    ...
    category: 'Volume',
    overlay: true,
    metadata: volumeFootprintIndicator.metadata,
    inputConfig: volumeFootprintIndicator.inputConfig as InputConfig[],
    plotConfig: volumeFootprintIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...volumeFootprintIndicator.defaultInputs },
    calculate: volumeFootprintIndicator.calculate,
  },
  {
    id: 'hyper-trend',
    group: 'community',
    name: 'HyperTrend [LuxAlgo]',
    shortName: 'HyperTrend',
    category: 'Trend',
    overlay: true,
    metadata: hyperTrendIndicator.metadata,
    inputConfig: hyperTrendIndicator.inputConfig as InputConfig[],
    plotConfig: hyperTrendIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...hyperTrendIndicator.defaultInputs },
    calculate: hyperTrendIndicator.calculate,
  },
  {
    id: 'trendlines-with-breaks',
    group: 'community',
    name: 'Trendlines with Breaks [LuxAlgo]',
    shortName: 'TwB',
    category: 'Trend',
    overlay: true,
    metadata: trendlinesWithBreaksIndicator.metadata,
    inputConfig: trendlinesWithBreaksIndicator.inputConfig as InputConfig[],
    plotConfig: trendlinesWithBreaksIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...trendlinesWithBreaksIndicator.defaultInputs },
    calculate: trendlinesWithBreaksIndicator.calculate,
  },
  {
    id: 'trend-impulse-channels',
    group: 'community',
    name: 'Trend Impulse Channels',
    shortName: 'TIC',
    category: 'Trend',
    overlay: true,
    metadata: trendImpulseChannelsIndicator.metadata,
    inputConfig: trendImpulseChannelsIndicator.inputConfig as InputConfig[],
    plotConfig: trendImpulseChannelsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...trendImpulseChannelsIndicator.defaultInputs },
    calculate: trendImpulseChannelsIndicator.calculate,
  },
  {
    id: 'liquidity-grabs',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: liquidityGrabsIndicator.metadata,
    inputConfig: liquidityGrabsIndicator.inputConfig as InputConfig[],
    plotConfig: liquidityGrabsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...liquidityGrabsIndicator.defaultInputs },
    calculate: liquidityGrabsIndicator.calculate,
  },
  {
    id: 'rsi-tops-bottoms',
    group: 'community',
    ...
    category: 'Momentum',
    overlay: false,
    metadata: rsiTopsBottomsIndicator.metadata,
    inputConfig: rsiTopsBottomsIndicator.inputConfig as InputConfig[],
    plotConfig: rsiTopsBottomsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...rsiTopsBottomsIndicator.defaultInputs },
    calculate: rsiTopsBottomsIndicator.calculate,
  },
  {
    id: 'hull-butterfly-oscillator',
    group: 'community',
    name: 'Hull Butterfly Oscillator',
    shortName: 'HBO',
    category: 'Momentum',
    overlay: false,
    metadata: hullButterflyOscillatorIndicator.metadata,
    inputConfig: hullButterflyOscillatorIndicator.inputConfig as InputConfig[],
    plotConfig: hullButterflyOscillatorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...hullButterflyOscillatorIndicator.defaultInputs },
    calculate: hullButterflyOscillatorIndicator.calculate,
  },
  {
    id: 'gmma-oscillator',
    group: 'community',
    name: 'GMMA Oscillator',
    shortName: 'GMMAOSC',
    category: 'Trend',
    overlay: false,
    metadata: gmmaOscillatorIndicator.metadata,
    inputConfig: gmmaOscillatorIndicator.inputConfig as InputConfig[],
    plotConfig: gmmaOscillatorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...gmmaOscillatorIndicator.defaultInputs },
    calculate: gmmaOscillatorIndicator.calculate,
  },
  {
    id: 'bjorgum-tsi',
    group: 'community',
    ...
    category: 'Momentum',
    overlay: false,
    metadata: bjorgumTsiIndicator.metadata,
    inputConfig: bjorgumTsiIndicator.inputConfig as InputConfig[],
    plotConfig: bjorgumTsiIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...bjorgumTsiIndicator.defaultInputs },
    calculate: bjorgumTsiIndicator.calculate,
  },
  {
    id: 'adx-di-gu5',
    group: 'community',
    ...
    category: 'Trend',
    overlay: false,
    metadata: adxDiGu5Indicator.metadata,
    inputConfig: adxDiGu5Indicator.inputConfig as InputConfig[],
    plotConfig: adxDiGu5Indicator.plotConfig as PlotConfig[],
    defaultInputs: { ...adxDiGu5Indicator.defaultInputs },
    calculate: adxDiGu5Indicator.calculate,
  },
  {
    id: 'market-structure-trailing-stop',
    group: 'community',
    name: 'Market Structure Trailing Stop',
    shortName: 'MSTS',
    category: 'Trend',
    overlay: true,
    metadata: marketStructureTrailingStopIndicator.metadata,
    inputConfig: marketStructureTrailingStopIndicator.inputConfig as InputConfig[],
    plotConfig: marketStructureTrailingStopIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...marketStructureTrailingStopIndicator.defaultInputs },
    calculate: marketStructureTrailingStopIndicator.calculate,
  },
  {
    id: 'dynamic-structure-indicator',
    group: 'community',
    name: 'Dynamic Structure Indicator',
    shortName: 'DSI',
    category: 'Trend',
    overlay: true,
    metadata: dynamicStructureIndicatorIndicator.metadata,
    inputConfig: dynamicStructureIndicatorIndicator.inputConfig as InputConfig[],
    plotConfig: dynamicStructureIndicatorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...dynamicStructureIndicatorIndicator.defaultInputs },
    calculate: dynamicStructureIndicatorIndicator.calculate,
  },
  {
    id: 'standardized-macd-ha',
    group: 'community',
    name: 'Standardized MACD HA',
    shortName: 'SMACDHA',
    category: 'Momentum',
    overlay: false,
    metadata: standardizedMacdHaIndicator.metadata,
    inputConfig: standardizedMacdHaIndicator.inputConfig as InputConfig[],
    plotConfig: standardizedMacdHaIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...standardizedMacdHaIndicator.defaultInputs },
    calculate: standardizedMacdHaIndicator.calculate,
  },
  {
    id: 'hott-lott',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: hottLottIndicator.metadata,
    inputConfig: hottLottIndicator.inputConfig as InputConfig[],
    plotConfig: hottLottIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...hottLottIndicator.defaultInputs },
    calculate: hottLottIndicator.calculate,
  },
  {
    id: 'stochastic-heat-map',
    group: 'community',
    name: 'Stochastic Heat Map',
    shortName: 'SHM',
    category: 'Momentum',
    overlay: false,
    metadata: stochasticHeatMapIndicator.metadata,
    inputConfig: stochasticHeatMapIndicator.inputConfig as InputConfig[],
    plotConfig: stochasticHeatMapIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...stochasticHeatMapIndicator.defaultInputs },
    calculate: stochasticHeatMapIndicator.calculate,
  },
  {
    id: 'tdi-rsi',
    group: 'community',
    name: 'TDI - Traders Dynamic Index',
    shortName: 'TDI',
    category: 'Momentum',
    overlay: false,
    metadata: tdiRsiIndicator.metadata,
    inputConfig: tdiRsiIndicator.inputConfig as InputConfig[],
    plotConfig: tdiRsiIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...tdiRsiIndicator.defaultInputs },
    calculate: tdiRsiIndicator.calculate,
  },
  {
    id: 'heikin-ashi-rsi-oscillator',
    group: 'community',
    name: 'Heikin Ashi RSI Oscillator',
    shortName: 'HA-RSI',
    category: 'Momentum',
    overlay: false,
    metadata: heikinAshiRsiOscillatorIndicator.metadata,
    inputConfig: heikinAshiRsiOscillatorIndicator.inputConfig as InputConfig[],
    plotConfig: heikinAshiRsiOscillatorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...heikinAshiRsiOscillatorIndicator.defaultInputs },
    calculate: heikinAshiRsiOscillatorIndicator.calculate,
  },
  {
    id: 'ma-strategy-emperor',
    group: 'community',
    name: 'MA Strategy Emperor',
    shortName: 'MAEmperor',
    category: 'Trend',
    overlay: true,
    metadata: maStrategyEmperorIndicator.metadata,
    inputConfig: maStrategyEmperorIndicator.inputConfig as InputConfig[],
    plotConfig: maStrategyEmperorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...maStrategyEmperorIndicator.defaultInputs },
    calculate: maStrategyEmperorIndicator.calculate,
  },
  {
    id: 'multiple-divergences',
    group: 'community',
    name: 'Multiple Divergences',
    shortName: 'Multi Div',
    category: 'Momentum',
    overlay: true,
    metadata: multipleDivergencesIndicator.metadata,
    inputConfig: multipleDivergencesIndicator.inputConfig as InputConfig[],
    plotConfig: multipleDivergencesIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...multipleDivergencesIndicator.defaultInputs },
    calculate: multipleDivergencesIndicator.calculate,
  },
  {
    id: 'price-divergence-detector',
    group: 'community',
    name: 'Price Divergence Detector',
    shortName: 'Div Detect',
    category: 'Momentum',
    overlay: true,
    metadata: priceDivergenceDetectorIndicator.metadata,
    inputConfig: priceDivergenceDetectorIndicator.inputConfig as InputConfig[],
    plotConfig: priceDivergenceDetectorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...priceDivergenceDetectorIndicator.defaultInputs },
    calculate: priceDivergenceDetectorIndicator.calculate,
  },
  {
    id: 'qqe-cross',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: qqeCrossIndicator.metadata,
    inputConfig: qqeCrossIndicator.inputConfig as InputConfig[],
    plotConfig: qqeCrossIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...qqeCrossIndicator.defaultInputs },
    calculate: qqeCrossIndicator.calculate,
  },
  {
    ...
    category: 'Momentum',
    overlay: false,
    metadata: wavetrendOscillatorIndicator.metadata,
    inputConfig: wavetrendOscillatorIndicator.inputConfig as InputConfig[],
    plotConfig: wavetrendOscillatorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...wavetrendOscillatorIndicator.defaultInputs },
    calculate: wavetrendOscillatorIndicator.calculate,
  },
  {
    id: 'open-close-cross',
    group: 'community',
    name: 'Open Close Cross',
    shortName: 'OCC',
    category: 'Momentum',
    overlay: false,
    metadata: openCloseCrossIndicator.metadata,
    inputConfig: openCloseCrossIndicator.inputConfig as InputConfig[],
    plotConfig: openCloseCrossIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...openCloseCrossIndicator.defaultInputs },
    calculate: openCloseCrossIndicator.calculate,
  },
  {
    id: 'super-guppy',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: superGuppyIndicator.metadata,
    inputConfig: superGuppyIndicator.inputConfig as InputConfig[],
    plotConfig: superGuppyIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...superGuppyIndicator.defaultInputs },
    calculate: superGuppyIndicator.calculate,
  },
  {
    id: 'bjorgum-autotrail',
    group: 'community',
    name: 'Bjorgum AutoTrail',
    shortName: 'BjAutoTrail',
    category: 'Trend',
    overlay: true,
    metadata: bjorgumAutotrailIndicator.metadata,
    inputConfig: bjorgumAutotrailIndicator.inputConfig as InputConfig[],
    plotConfig: bjorgumAutotrailIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...bjorgumAutotrailIndicator.defaultInputs },
    calculate: bjorgumAutotrailIndicator.calculate,
  },
  {
    id: 'delta-rsi-oscillator',
    group: 'community',
    name: 'Delta-RSI Oscillator',
    shortName: 'DRSI',
    category: 'Momentum',
    overlay: false,
    metadata: deltaRsiOscillatorIndicator.metadata,
    inputConfig: deltaRsiOscillatorIndicator.inputConfig as InputConfig[],
    plotConfig: deltaRsiOscillatorIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...deltaRsiOscillatorIndicator.defaultInputs },
    calculate: deltaRsiOscillatorIndicator.calculate,
  },
  {
    id: 'macd-reloaded',
    group: 'community',
    ...
    category: 'Momentum',
    overlay: false,
    metadata: macdReloadedIndicator.metadata,
    inputConfig: macdReloadedIndicator.inputConfig as InputConfig[],
    plotConfig: macdReloadedIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...macdReloadedIndicator.defaultInputs },
    calculate: macdReloadedIndicator.calculate,
  },
  {
    id: 'renko-chart',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: renkoChartIndicator.metadata,
    inputConfig: renkoChartIndicator.inputConfig as InputConfig[],
    plotConfig: renkoChartIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...renkoChartIndicator.defaultInputs },
    calculate: renkoChartIndicator.calculate,
  },
  {
    id: 'redk-everex',
    group: 'community',
    ...
    category: 'Momentum',
    overlay: false,
    metadata: redkEverexIndicator.metadata,
    inputConfig: redkEverexIndicator.inputConfig as InputConfig[],
    plotConfig: redkEverexIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...redkEverexIndicator.defaultInputs },
    calculate: redkEverexIndicator.calculate,
  },
  {
    id: 'boom-hunter-pro',
    group: 'community',
    ...
    category: 'Momentum',
    overlay: false,
    metadata: boomHunterProIndicator.metadata,
    inputConfig: boomHunterProIndicator.inputConfig as InputConfig[],
    plotConfig: boomHunterProIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...boomHunterProIndicator.defaultInputs },
    calculate: boomHunterProIndicator.calculate,
  },
  {
    id: 'big-snapper-alerts',
    group: 'community',
    name: 'Big Snapper Alerts R3.0',
    shortName: 'SNAPPER',
    category: 'Trend',
    overlay: true,
    metadata: bigSnapperAlertsIndicator.metadata,
    inputConfig: bigSnapperAlertsIndicator.inputConfig as InputConfig[],
    plotConfig: bigSnapperAlertsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...bigSnapperAlertsIndicator.defaultInputs },
    calculate: bigSnapperAlertsIndicator.calculate,
  },
  {
    id: 'rsi-supply-demand',
    group: 'community',
    name: 'RSI Supply/Demand',
    shortName: 'RSI S/D',
    category: 'Trend',
    overlay: true,
    metadata: rsiSupplyDemandIndicator.metadata,
    inputConfig: rsiSupplyDemandIndicator.inputConfig as InputConfig[],
    plotConfig: rsiSupplyDemandIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...rsiSupplyDemandIndicator.defaultInputs },
    calculate: rsiSupplyDemandIndicator.calculate,
  },
  {
    id: 'ultimate-buy-sell',
    group: 'community',
    name: 'Ultimate Buy & Sell',
    shortName: 'UltimateBS',
    category: 'Trend',
    overlay: true,
    metadata: ultimateBuySellIndicator.metadata,
    inputConfig: ultimateBuySellIndicator.inputConfig as InputConfig[],
    plotConfig: ultimateBuySellIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...ultimateBuySellIndicator.defaultInputs },
    calculate: ultimateBuySellIndicator.calculate,
  },
  {
    id: 'macd-support-resistance',
    group: 'community',
    name: 'MACD Support and Resistance [ChartPrime]',
    shortName: 'MACD S/R',
    category: 'Momentum',
    overlay: false,
    metadata: macdSupportResistanceIndicator.metadata,
    inputConfig: macdSupportResistanceIndicator.inputConfig as InputConfig[],
    plotConfig: macdSupportResistanceIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...macdSupportResistanceIndicator.defaultInputs },
    calculate: macdSupportResistanceIndicator.calculate,
  },
  {
    id: 'liquidity-levels',
    group: 'community',
    name: 'Liquidity Levels [LuxAlgo]',
    shortName: 'LiqLevels',
    category: 'Trend',
    overlay: true,
    metadata: liquidityLevelsIndicator.metadata,
    inputConfig: liquidityLevelsIndicator.inputConfig as InputConfig[],
    plotConfig: liquidityLevelsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...liquidityLevelsIndicator.defaultInputs },
    calculate: liquidityLevelsIndicator.calculate,
  },
  {
    id: 'zigzag-fibonacci',
    group: 'community',
    name: 'ZigZag with Fibonacci Levels',
    shortName: 'ZZ Fibo',
    category: 'Trend',
    overlay: true,
    metadata: zigzagFibonacciIndicator.metadata,
    inputConfig: zigzagFibonacciIndicator.inputConfig as InputConfig[],
    plotConfig: zigzagFibonacciIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...zigzagFibonacciIndicator.defaultInputs },
    calculate: zigzagFibonacciIndicator.calculate,
  },
  {
    id: 'trend-lines-v2',
    group: 'community',
    ...
    category: 'Trend',
    overlay: true,
    metadata: trendLinesV2Indicator.metadata,
    inputConfig: trendLinesV2Indicator.inputConfig as InputConfig[],
    plotConfig: trendLinesV2Indicator.plotConfig as PlotConfig[],
    defaultInputs: { ...trendLinesV2Indicator.defaultInputs },
    calculate: trendLinesV2Indicator.calculate,
  },
  {
    id: 'order-blocks-signals',
    group: 'community',
    name: 'Order Blocks with Signals',
    shortName: 'OBSignals',
    category: 'Trend',
    overlay: true,
    metadata: orderBlocksSignalsIndicator.metadata,
    inputConfig: orderBlocksSignalsIndicator.inputConfig as InputConfig[],
    plotConfig: orderBlocksSignalsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...orderBlocksSignalsIndicator.defaultInputs },
    calculate: orderBlocksSignalsIndicator.calculate,
  },
  {
    id: 'support-resistance-channels',
    group: 'community',
    name: 'Support Resistance Channels',
    shortName: 'SRChannel',
    category: 'Trend',
    overlay: true,
    metadata: supportResistanceChannelsIndicator.metadata,
    inputConfig: supportResistanceChannelsIndicator.inputConfig as InputConfig[],
    plotConfig: supportResistanceChannelsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...supportResistanceChannelsIndicator.defaultInputs },
    calculate: supportResistanceChannelsIndicator.calculate,
  },
  {
    id: 'auto-trendline',
    group: 'community',
    name: 'Auto Trendline [DojiEmoji]',
    shortName: 'AutoTL',
    category: 'Trend',
    overlay: true,
    metadata: autoTrendlineIndicator.metadata,
    inputConfig: autoTrendlineIndicator.inputConfig as InputConfig[],
    plotConfig: autoTrendlineIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...autoTrendlineIndicator.defaultInputs },
    calculate: autoTrendlineIndicator.calculate,
  },
  {
    id: 'liquidity-sweeps',
    group: 'community',
    name: 'Liquidity Sweeps [LuxAlgo]',
    shortName: 'LiqSweeps',
    category: 'Trend',
    overlay: true,
    metadata: liquiditySweepsIndicator.metadata,
    inputConfig: liquiditySweepsIndicator.inputConfig as InputConfig[],
    plotConfig: liquiditySweepsIndicator.plotConfig as PlotConfig[],
    defaultInputs: { ...liquiditySweepsIndicator.defaultInputs },
    calculate: liquiditySweepsIndicator.calculate,
  },
  {
    id: 'price-volume-profile',
    group: 'community',
    name: 'Price & Volume Profile (Expo)',
    shortName: 'PVP',
    category: 'Volume',
    overlay: true,
    metadata: priceVolumeProfileIndicator.metadata,
    inputConfig: priceVolumeProfileIndicator.inputConfig as InputConfig[],
    plotConfig: priceVolumeProfileIndicator.plotConfig as PlotConfig[],
